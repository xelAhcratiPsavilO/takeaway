...
describe 'User Stories' do
  let(:takeaway) { Takeaway.new(menu, order, sms, config, client) }
  ...
  # I would like to receive "Thank you! Your order was placed and will be delivered before 18:52" after I have ordered
